...
6. `cinepostaScore` es la única fuente de verdad para una película valorada: entero de 1 a 10, con etiqueta derivada por el sitio. No inventes score para una película todavía no rankeada ni agregues etiquetas personalizadas de valoración.
