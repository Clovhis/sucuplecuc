...
Los assets están en `public/brand/awards/illustrated/` y se sirven optimizados como WebP transparente de 256 × 256 px. Todos los tipos de galardón actualmente presentes en el catálogo —incluidos los menos frecuentes— tienen una ilustración dedicada; `generic.webp` queda como respaldo para valores desconocidos. La variante BFI usa una medalla dorada con cruz azul y cinta roja, inspirada en la referencia visual del Fellowship y sin reproducir el logotipo oficial.
