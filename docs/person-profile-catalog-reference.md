...
| Alfred Hitchcock | `alfred-hitchcock` | /personas/alfred-hitchcock/ | Director | 2 | 3 |
| America Ferrera | `america-ferrera` | /personas/america-ferrera/ | Actriz | 2 | 3 |
| Amy Adams | `amy-adams` | /personas/amy-adams/ | Actriz | 3 | 3 |
| Ana de Armas | `ana-de-armas` | /personas/ana-de-armas/ | Actriz | 3 | 3 |
| Andrew Garfield | `andrew-garfield` | /personas/andrew-garfield/ | Actor | 3 | 3 |
| Andy Serkis | `andy-serkis` | /personas/andy-serkis/ | Actor | 2 | 3 |
| Angelina Jolie | `angelina-jolie` | /personas/angelina-jolie/ | Actriz / Directora | 3 | 3 |
...
| Ariana Grande | `ariana-grande` | /personas/ariana-grande/ | Actriz | 2 | 5 |
| Arnold Schwarzenegger | `arnold-schwarzenegger` | /personas/arnold-schwarzenegger/ | Actor | 4 | 3 |
| Austin Butler | `austin-butler` | /personas/austin-butler/ | Actor | 1 | 3 |
| Awkwafina | `awkwafina` | /personas/awkwafina/ | Actriz | 2 | 3 |
| Ayo Edebiri | `ayo-edebiri` | /personas/ayo-edebiri/ | Actriz | 1 | 3 |
| Barry Keoghan | `barry-keoghan` | /personas/barry-keoghan/ | Actor | 3 | 3 |
| Ben Affleck | `ben-affleck` | /personas/ben-affleck/ | Actor | 4 | 3 |
| Ben Kingsley | `ben-kingsley` | /personas/ben-kingsley/ | Actor | 2 | 3 |
| Benedict Cumberbatch | `benedict-cumberbatch` | /personas/benedict-cumberbatch/ | Actor | 4 | 3 |
| Billy Wilder | `billy-wilder` | /personas/billy-wilder/ | Director | 2 | 3 |
| Bong Joon-ho | `bong-joon-ho` | /personas/bong-joon-ho/ | Director | 2 | 2 |
| Brad Bird | `brad-bird` | /personas/brad-bird/ | Director | 3 | 3 |
| Brad Dourif | `brad-dourif` | /personas/brad-dourif/ | Actor | 4 | 3 |
| Brad Pitt | `brad-pitt` | /personas/brad-pitt/ | Actor / Productor | 4 | 4 |
| Bradley Cooper | `bradley-cooper` | /personas/bradley-cooper/ | Actor | 3 | 3 |
| Brady Corbet | `brady-corbet` | /personas/brady-corbet/ | Director | 1 | 3 |
| Brendan Fraser | `brendan-fraser` | /personas/brendan-fraser/ | Actor | 2 | 3 |
| Brendan Gleeson | `brendan-gleeson` | /personas/brendan-gleeson/ | Actor | 2 | 3 |
| Brian Tyree Henry | `brian-tyree-henry` | /personas/brian-tyree-henry/ | Actor | 3 | 3 |
| Brie Larson | `brie-larson` | /personas/brie-larson/ | Actriz | 2 | 3 |
...
| Catherine O'Hara | `catherine-o-hara` | /personas/catherine-o-hara/ | Actriz | 3 | 3 |
...
| Chris Evans | `chris-evans` | /personas/chris-evans/ | Actor | 4 | 3 |
| Chris Hemsworth | `chris-hemsworth` | /personas/chris-hemsworth/ | Actor | 4 | 3 |
| Chris Pine | `chris-pine` | /personas/chris-pine/ | Actor | 3 | 3 |
| Chris Pratt | `chris-pratt` | /personas/chris-pratt/ | Actor | 4 | 3 |
| Christian Bale | `christian-bale` | /personas/christian-bale/ | Actor | 4 | 3 |
| Christoph Waltz | `christoph-waltz` | /personas/christoph-waltz/ | Actor | 4 | 3 |
| Christopher Lloyd | `christopher-lloyd` | /personas/christopher-lloyd/ | Actor | 3 | 3 |
| Christopher McQuarrie | `christopher-mcquarrie` | /personas/christopher-mcquarrie/ | Director | 4 | 3 |
| Christopher Nolan | `christopher-nolan` | /personas/christopher-nolan/ | Director / Productor / Guionista | 4 | 3 |
| Christopher Plummer | `christopher-plummer` | /personas/christopher-plummer/ | Actor | 2 | 3 |
...
| Colman Domingo | `colman-domingo` | /personas/colman-domingo/ | Actor | 1 | 3 |
| Coralie Fargeat | `coralie-fargeat` | /personas/coralie-fargeat/ | Director | 1 | 3 |
| Courteney Cox | `courteney-cox` | /personas/courteney-cox/ | Actriz | 4 | 3 |
| Cynthia Erivo | `cynthia-erivo` | /personas/cynthia-erivo/ | Actriz | 2 | 3 |
| Daisy Edgar-Jones | `daisy-edgar-jones` | /personas/daisy-edgar-jones/ | Actriz | 1 | 3 |
...
| Demi Moore | `demi-moore` | /personas/demi-moore/ | Actriz | 1 | 3 |
| Denis Villeneuve | `denis-villeneuve` | /personas/denis-villeneuve/ | Director | 3 | 3 |
| Denzel Washington | `denzel-washington` | /personas/denzel-washington/ | Actor / Director | 1 | 3 |
| Dev Patel | `dev-patel` | /personas/dev-patel/ | Actor | 2 | 3 |
| Diane Keaton | `diane-keaton` | /personas/diane-keaton/ | Actriz | 2 | 3 |
| Diego Peretti | `diego-peretti` | /personas/diego-peretti/ | Actor | 1 | 3 |
| Dolores Fonzi | `dolores-fonzi` | /personas/dolores-fonzi/ | Actriz | 4 | 3 |
| Don Cheadle | `don-cheadle` | /personas/don-cheadle/ | Actor | 4 | 3 |
| Donald Pleasence | `donald-pleasence` | /personas/donald-pleasence/ | Actor | 4 | 3 |
| Dustin Hoffman | `dustin-hoffman` | /personas/dustin-hoffman/ | Actor | 4 | 3 |
| Dwayne Johnson | `dwayne-johnson` | /personas/dwayne-johnson/ | Actor | 4 | 3 |
| Ebon Moss-Bachrach | `ebon-moss-bachrach` | /personas/ebon-moss-bachrach/ | Actor | 1 | 3 |
| Ed Harris | `ed-harris` | /personas/ed-harris/ | Actor | 4 | 3 |
| Eddie Murphy | `eddie-murphy` | /personas/eddie-murphy/ | Actor | 2 | 3 |
| Eddie Redmayne | `eddie-redmayne` | /personas/eddie-redmayne/ | Actor | 3 | 3 |
| Eduardo Blanco | `eduardo-blanco` | /personas/eduardo-blanco/ | Actor | 1 | 3 |
| Edward Berger | `edward-berger` | /personas/edward-berger/ | Director | 2 | 3 |
| Edward Norton | `edward-norton` | /personas/edward-norton/ | Actor | 3 | 3 |
| Elle Fanning | `elle-fanning` | /personas/elle-fanning/ | Actriz | 1 | 3 |
| Emily Blunt | `emily-blunt` | /personas/emily-blunt/ | Actriz | 3 | 3 |
| Emily Watson | `emily-watson` | /personas/emily-watson/ | Actriz | 2 | 3 |
| Emma Stone | `emma-stone` | /personas/emma-stone/ | Actriz / Productora | 4 | 3 |
| Emma Watson | `emma-watson` | /personas/emma-watson/ | Actriz | 4 | 3 |
| Eric Bana | `eric-bana` | /personas/eric-bana/ | Actor | 2 | 3 |
| Érica Rivas | `erica-rivas` | /personas/erica-rivas/ | Actriz | 2 | 3 |
| Eva Green | `eva-green` | /personas/eva-green/ | Actriz | 3 | 3 |
| Eva Marie Saint | `eva-marie-saint` | /personas/eva-marie-saint/ | Actriz | 2 | 3 |
...
| F. Murray Abraham | `f-murray-abraham` | /personas/f-murray-abraham/ | Actor | 2 | 3 |
| Felicity Jones | `felicity-jones` | /personas/felicity-jones/ | Actriz | 2 | 3 |
...
| Gal Gadot | `gal-gadot` | /personas/gal-gadot/ | Actriz | 4 | 2 |
| Gary Oldman | `gary-oldman` | /personas/gary-oldman/ | Actor | 3 | 3 |
| Gastón Pauls | `gaston-pauls` | /personas/gaston-pauls/ | Actor | 1 | 3 |
| Gene Hackman | `gene-hackman` | /personas/gene-hackman/ | Actor | 4 | 3 |
| Geoffrey Rush | `geoffrey-rush` | /personas/geoffrey-rush/ | Actor | 4 | 3 |
| George Clooney | `george-clooney` | /personas/george-clooney/ | Actor | 2 | 3 |
| George Lucas | `george-lucas` | /personas/george-lucas/ | Director / Guionista / Productor | 4 | 3 |
| George Miller | `george-miller` | /personas/george-miller/ | Director | 4 | 3 |
...
| Guillermo Francella | `guillermo-francella` | /personas/guillermo-francella/ | Actor | 4 | 3 |
| Gwyneth Paltrow | `gwyneth-paltrow` | /personas/gwyneth-paltrow/ | Actriz | 4 | 3 |
...
| James Franco | `james-franco` | /personas/james-franco/ | Actor | 3 | 3 |
| James Gunn | `james-gunn` | /personas/james-gunn/ | Director | 4 | 3 |
| James Mangold | `james-mangold` | /personas/james-mangold/ | Director | 3 | 3 |
| James McAvoy | `james-mcavoy` | /personas/james-mcavoy/ | Actor | 4 | 3 |
| Jamie Foxx | `jamie-foxx` | /personas/jamie-foxx/ | Actor | 3 | 3 |
| Jamie Lee Curtis | `jamie-lee-curtis` | /personas/jamie-lee-curtis/ | Actriz | 4 | 3 |
| Jared Leto | `jared-leto` | /personas/jared-leto/ | Actor | 3 | 3 |
| Jason Bateman | `jason-bateman` | /personas/jason-bateman/ | Actor | 3 | 3 |
| Jason Momoa | `jason-momoa` | /personas/jason-momoa/ | Actor | 3 | 3 |
| Javier Bardem | `javier-bardem` | /personas/javier-bardem/ | Actor | 4 | 3 |
| Jeff Bridges | `jeff-bridges` | /personas/jeff-bridges/ | Actor | 2 | 3 |
| Jeff Goldblum | `jeff-goldblum` | /personas/jeff-goldblum/ | Actor | 4 | 3 |
| Jeffrey Wright | `jeffrey-wright` | /personas/jeffrey-wright/ | Actor | 2 | 3 |
| Jenna Ortega | `jenna-ortega` | /personas/jenna-ortega/ | Actriz | 2 | 3 |
| Jennifer Connelly | `jennifer-connelly` | /personas/jennifer-connelly/ | Actriz | 4 | 3 |
| Jennifer Garner | `jennifer-garner` | /personas/jennifer-garner/ | Actriz | 2 | 3 |
| Jennifer Lawrence | `jennifer-lawrence` | /personas/jennifer-lawrence/ | Actriz | 3 | 3 |
| Jennifer Tilly | `jennifer-tilly` | /personas/jennifer-tilly/ | Actriz | 2 | 3 |
| Jeremy Renner | `jeremy-renner` | /personas/jeremy-renner/ | Actor | 2 | 3 |
| Jeremy Strong | `jeremy-strong` | /personas/jeremy-strong/ | Actor | 1 | 3 |
| Jesse Eisenberg | `jesse-eisenberg` | /personas/jesse-eisenberg/ | Actor | 3 | 3 |
| Jesse Plemons | `jesse-plemons` | /personas/jesse-plemons/ | Actor | 1 | 3 |
| Jessica Chastain | `jessica-chastain` | /personas/jessica-chastain/ | Actriz | 3 | 3 |
| Jessie Buckley | `jessie-buckley` | /personas/jessie-buckley/ | Actriz | 2 | 3 |
| Jim Carrey | `jim-carrey` | /personas/jim-carrey/ | Actor | 2 | 3 |
| Joaquín Furriel | `joaquin-furriel` | /personas/joaquin-furriel/ | Actor | 1 | 2 |
...
| John Goodman | `john-goodman` | /personas/john-goodman/ | Actor | 2 | 3 |
| John Lithgow | `john-lithgow` | /personas/john-lithgow/ | Actor / Autor | 2 | 3 |
| John Malkovich | `john-malkovich` | /personas/john-malkovich/ | Actor | 2 | 3 |
...
| Jon Voight | `jon-voight` | /personas/jon-voight/ | Actor | 2 | 3 |
...
| Keira Knightley | `keira-knightley` | /personas/keira-knightley/ | Actriz | 2 | 3 |
| Keke Palmer | `keke-palmer` | /personas/keke-palmer/ | Actriz | 1 | 3 |
| Kenneth Branagh | `kenneth-branagh` | /personas/kenneth-branagh/ | Director | 3 | 3 |
| Kevin Costner | `kevin-costner` | /personas/kevin-costner/ | Actor | 2 | 3 |
| Kieran Culkin | `kieran-culkin` | /personas/kieran-culkin/ | Actor | 1 | 3 |
| Kim Basinger | `kim-basinger` | /personas/kim-basinger/ | Actriz | 1 | 3 |
| Kirsten Dunst | `kirsten-dunst` | /personas/kirsten-dunst/ | Actriz | 4 | 3 |
| Kris Kristofferson | `kris-kristofferson` | /personas/kris-kristofferson/ | Actor | 3 | 3 |
| Kristen Wiig | `kristen-wiig` | /personas/kristen-wiig/ | Actriz | 3 | 3 |
| Laura Dern | `laura-dern` | /personas/laura-dern/ | Actriz | 2 | 3 |
| Laurence Fishburne | `laurence-fishburne` | /personas/laurence-fishburne/ | Actor | 4 | 3 |
| Leonardo DiCaprio | `leonardo-dicaprio` | /personas/leonardo-dicaprio/ | Actor / Productor | 4 | 3 |
| Leonardo Sbaraglia | `leonardo-sbaraglia` | /personas/leonardo-sbaraglia/ | Actor | 3 | 3 |
| Liam Neeson | `liam-neeson` | /personas/liam-neeson/ | Actor | 4 | 3 |
| Linda Hamilton | `linda-hamilton` | /personas/linda-hamilton/ | Actriz | 3 | 3 |
| Luca Guadagnino | `luca-guadagnino` | /personas/luca-guadagnino/ | Director | 1 | 3 |
| Lucrecia Martel | `lucrecia-martel` | /personas/lucrecia-martel/ | Director | 2 | 3 |
| Luis Brandoni | `luis-brandoni` | /personas/luis-brandoni/ | Actor | 4 | 3 |
| Luis Ziembrowski | `luis-ziembrowski` | /personas/luis-ziembrowski/ | Actor | 2 | 3 |
| Lupita Nyong'o | `lupita-nyong-o` | /personas/lupita-nyong-o/ | Actriz | 4 | 2 |
| Mads Mikkelsen | `mads-mikkelsen` | /personas/mads-mikkelsen/ | Actor | 1 | 3 |
| Mahershala Ali | `mahershala-ali` | /personas/mahershala-ali/ | Actor | 2 | 3 |
| Margaret Qualley | `margaret-qualley` | /personas/margaret-qualley/ | Actriz | 2 | 3 |
| Margot Robbie | `margot-robbie` | /personas/margot-robbie/ | Actriz | 3 | 3 |
| Mark Hamill | `mark-hamill` | /personas/mark-hamill/ | Actor | 4 | 3 |
| Mark Ruffalo | `mark-ruffalo` | /personas/mark-ruffalo/ | Actor | 4 | 3 |
| Mark Wahlberg | `mark-wahlberg` | /personas/mark-wahlberg/ | Actor | 2 | 3 |
| Marlon Brando | `marlon-brando` | /personas/marlon-brando/ | Actor | 3 | 3 |
| Martin Scorsese | `martin-scorsese` | /personas/martin-scorsese/ | Director / Productor / Guionista | 4 | 3 |
| Martina Gusmán | `martina-gusman` | /personas/martina-gusman/ | Actriz | 2 | 3 |
| Matt Damon | `matt-damon` | /personas/matt-damon/ | Actor | 4 | 3 |
| Matt Reeves | `matt-reeves` | /personas/matt-reeves/ | Director | 3 | 3 |
| Mauricio Dayub | `mauricio-dayub` | /personas/mauricio-dayub/ | Actor | 1 | 3 |
| Mel Gibson | `mel-gibson` | /personas/mel-gibson/ | Actor | 4 | 3 |
...
| Michael Fassbender | `michael-fassbender` | /personas/michael-fassbender/ | Actor | 4 | 2 |
...
| Nicolas Cage | `nicolas-cage` | /personas/nicolas-cage/ | Actor | 3 | 3 |
| Norma Aleandro | `norma-aleandro` | /personas/norma-aleandro/ | Actriz | 2 | 3 |
| Orlando Bloom | `orlando-bloom` | /personas/orlando-bloom/ | Actor | 3 | 3 |
...
| Paul Mescal | `paul-mescal` | /personas/paul-mescal/ | Actor | 2 | 3 |
| Paul Rudd | `paul-rudd` | /personas/paul-rudd/ | Actor | 4 | 3 |
| Paul Thomas Anderson | `paul-thomas-anderson` | /personas/paul-thomas-anderson/ | Director | 1 | 3 |
| Paul Walker | `paul-walker` | /personas/paul-walker/ | Actor | 3 | 3 |
| Pedro Pascal | `pedro-pascal` | /personas/pedro-pascal/ | Actor | 3 | 3 |
...
| Rebecca Hall | `rebecca-hall` | /personas/rebecca-hall/ | Actriz | 2 | 3 |
| Renate Reinsve | `renate-reinsve` | /personas/renate-reinsve/ | Actriz | 1 | 3 |
| Ricardo Darín | `ricardo-darin` | /personas/ricardo-darin/ | Actor | 4 | 3 |
| Ridley Scott | `ridley-scott` | /personas/ridley-scott/ | Director | 4 | 3 |
| Robert De Niro | `robert-de-niro` | /personas/robert-de-niro/ | Actor / Productor | 4 | 3 |
| Robert Downey Jr. | `robert-downey-jr` | /personas/robert-downey-jr/ | Actor | 4 | 3 |
| Robert Eggers | `robert-eggers` | /personas/robert-eggers/ | Director | 1 | 3 |
| Robert Englund | `robert-englund` | /personas/robert-englund/ | Actor | 4 | 3 |
...
| Russell Crowe | `russell-crowe` | /personas/russell-crowe/ | Actor | 4 | 3 |
...
| Talia Shire | `talia-shire` | /personas/talia-shire/ | Actriz | 3 | 3 |
...
| Tom Hardy | `tom-hardy` | /personas/tom-hardy/ | Actor | 4 | 3 |
...
| Vin Diesel | `vin-diesel` | /personas/vin-diesel/ | Actor | 3 | 3 |
