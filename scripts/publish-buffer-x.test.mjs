...
import { nextDueAt, renderPostText, selectMovie, weightedXLength } from './publish-buffer-x.mjs';
...
assert.match(text, /^Si buscás algo de ciencia ficción, Akira \(1988\) recién llegó en Netflix\./u);
